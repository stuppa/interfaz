...
public class GuiLavadora extends javax.swing.JInternalFrame {
    ...
    protected void guardar() {
        Principal.listaElectrodomesticos.add(new Lavadora(Double.parseDouble(txtPrecioBase.getText()),
                Double.parseDouble(txtPeso.getText()), txtConsumo.getText().toUpperCase().charAt(0), txtColor.getText(), Integer.parseInt(txtCinco.getText())));
        //solo le agregue lo de la carga a lo que habiamos hecho en la clase eletrodomestico.veamos si funciona 
        JOptionPane.showMessageDialog(this, "Se vendio una Lavadora");
    }
    ...
    private void consultar() {
        ...
        for (Electrodomestico electrodomestico : listaElectrodomesticos) {//importo el arreglo
            ...
            if (electrodomestico instanceof Lavadora) {
                ...
                row.add(((Lavadora) electrodomestico).getCarga());
